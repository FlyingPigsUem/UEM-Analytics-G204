//Funcion que randomiza la saturacion venosa del paciente siguiendo los patrones acordados para el proyecto
function myFunction() {
  ...
  // Loop through the rows
   for (var i=2;i<sourceLen+2;i++){
     ...
     var randomChange = Number((Math.random() * 5).toFixed(1));
